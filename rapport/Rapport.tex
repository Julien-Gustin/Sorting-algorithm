...
Le tri est stable parce que, grâce aux $A[j]\leq A[j+1]$ les valeurs égaux n'interchange pas de place de plus vu que merge est lui aussi stable NewSort ne peut etre que stable, ainsi le tri gagne en rapidité.
	\begin{codebox}
